            ...
            <div class="search-bar">
                <form action="">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="enter your max price">
                    </div>
                    <div class="select">
        ...
        <div class="contener">
            ...
            <div class="portfolio-contener">
                @foreach ($house as $item)
                    <div class="card">
                        <img src="{{ asset('uploads/house/' . $item->img) }}" alt="">
                        <div class="info">
        ...
        <div class="contener">
            ...
            <div class="portfolio-contener">
                @foreach ($store as $item)
                    <div class="card">
                        <img src="{{ asset('uploads/store/' . $item->img) }}" alt="">
                        <div class="info">
                            <h3>{{ $item->city }}</h3>
                            <p>
        ...
        <div class="contener">
            ...
            <div class="portfolio-contener">
                @foreach ($chalet as $item)
                    <div class="card">
                        <div class="overlay">
                            <div><a href="">view Property</a></div>
                        </div>
                        <img src="{{ asset('uploads/chalet/' . $item->img) }}" alt="">
                        <div class="info">
                            <h3>city : {{ $item->city }}</h3>
                            <p>
                                My creative ability is very difficult to measure because it
